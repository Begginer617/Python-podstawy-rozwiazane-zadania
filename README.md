...
Napisz program przyjmujący 2 liczby całkowite (X,Y) i tworzy dwuwymiarową tablicę o wymiarach (X,Y). 
Każdy element i-tego wiersza i j-tej kolumny powinien mieć wartość i*j.
